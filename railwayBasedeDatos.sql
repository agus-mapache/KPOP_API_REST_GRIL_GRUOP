...
UPDATE Grupo SET ImageUrl = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQq-ChYZrGpoE1sj4I4HzPsZdICLW3QPjPs5JlI0SbE3NTAIAwuDE0Vos&s=10' WHERE Id = 1; -- IVE 
UPDATE Grupo SET ImageUrl = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-BVd6ZLCqskt7JGR9Ozs1RJLNMX0upwXRO9OOtRY5B_1zpjB9ajrEQwv0&s=10' WHERE Id = 2; -- BLACKPINK
UPDATE Grupo SET ImageUrl = 'https://i.scdn.co/image/ab6761610000e5eb3d8820046fd455b38d644864' WHERE Id = 3; -- TWICE
UPDATE Grupo SET ImageUrl = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdvAzh5y5Qntyc1pA1D-CQWI-k9t9zsDFxym_Wt--JHiTStOAZDGsq8Oud&s=10' WHERE Id = 4; -- aespa
